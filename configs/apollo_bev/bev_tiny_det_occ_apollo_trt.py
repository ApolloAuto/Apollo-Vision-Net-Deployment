_base_ = ["bev_tiny_det_occ_apollo.py", "../_base_/det2trt.py"]

model = dict(
    type="BEVFormerTRT",
    pts_bbox_head=dict(
        type="BEVFormerOccupancyHeadApolloTRT",
        transformer=dict(
...
default_shapes = dict(
    ...
    cameras=6,
    num_voxels=200*200*16,
    num_occ_classes={{_base_.model.pts_bbox_head.occupancy_classes}},
)
...
output_shapes = dict(
    ...
    outputs_occupancy=["num_voxels", "num_occ_classes"],
)
